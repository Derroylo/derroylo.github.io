...
If you want to test versions that are not ready yet for productive usage, you can activate it with a settings in the `.webdev.yml` file. [See reference](/0.3/reference/webdev_yml/config)
