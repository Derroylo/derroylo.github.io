...
The default folder that will be scanned for extensions is `.devcontainer/scripts`. Additional folders can be defined within ´webdev.yml\` configuration file. Check the [Reference section](/0.3/reference/webdev_yml/shell-scripts) to see on how this can be done.
...
![WebDev Extension](.././../../../../assets/images/0.3/gpt_extensions_shopware1.jpg)
...
![WebDev Extension](.././../../../../assets/images/0.3/gpt_extensions_shopware2.jpg)
...
![WebDev Extension](.././../../../../assets/images/0.3/gpt_extensions_shopware3.jpg)
