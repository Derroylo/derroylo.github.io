---
title: What is WebDev?
banner:
  content: >
    This feature is <strong>no longer maintained</strong>. See <a
    href="/getting_started/details/...">...</a> for the current approach.
slug: 0.3/getting_started/introduction/what_is_webdev
---
...
That being said, the next section shows some examples on what WebDev adds as functionality to the DevContainer setup. Checkout the [CLI](/0.3/cli/) page to see all available commands.
